...
<html>
	...
	<div class="container">
  		<div class="jumbotron">
            ...
            <form name="form1" class="display" method="POST" action="commonhome2.php">
	...
	for($list_day = 1; $list_day <= $days_in_month; $list_day++):
		if($list_day==$today && $month==$tomonth && $year==$toyear)
			...
			$calendar.= '<div class="day-number">'.$list_day.'</div>';
                        ...
                        $calendar.= '<a class="dropdown-toggle" data-toggle="dropdown">AM &nbsp;</a>';
	    
        
                        $calendar.='</div>';
                        
                        $calendar.= '<div class="pc">PC: ';
                        $calendar.= '<a class="dropdown-toggle" data-toggle="dropdown">GS &nbsp;</a>';
